...
{
	std::string properties{ "DaeRectLabel\n" };
	properties += PropertiesToString();
	const std::string str{ '"' };
	properties += "   Label=" + str + m_Label + str + "\n";
	properties += "   TextColor=" + str + std::to_string(m_TextColor.r) + "," + std::to_string(m_TextColor.g) + "," + std::to_string(m_TextColor.b) + "," + std::to_string(m_TextColor.a) + str + "\n";
	return properties;
}
