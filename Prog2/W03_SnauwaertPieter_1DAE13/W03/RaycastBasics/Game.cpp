...
{
	m_Vertices.push_back(Point2f{ 50,50 });
	m_Vertices.push_back(Point2f{ 50,400 });
	m_Vertices.push_back(Point2f{ 450,450 });
	m_Vertices.push_back(Point2f{ 800,400 });
	m_Vertices.push_back(Point2f{ 800,50 });
	m_Vertices.push_back(Point2f{ 450,25 });
}
...
void Game::Draw( ) const
{
	...
	if (utils::Raycast(m_Vertices, p1, p2, hit))
	{
		...
		hit.normal *= 30.f;
		DrawVector(hit.intersectPoint, hit.normal);
