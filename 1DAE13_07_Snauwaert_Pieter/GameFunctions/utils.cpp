...
#pragma region CollisionFunctionality
	...
	{
		Point2f topLeftPos1{ r1.left,r1.bottom+r1.height };
		Point2f BottomRightPos1{ r1.left + r1.width,r1.bottom };
		Point2f topLeftPos2{ r2.left,r2.bottom+r2.height };
		Point2f bottomRightPos2{ r2.left + r2.width,r2.bottom };
		if ((topLeftPos1.x == BottomRightPos1.x) || (topLeftPos1.y == BottomRightPos1.y)
			|| (topLeftPos2.x == bottomRightPos2.x) || (topLeftPos2.y == bottomRightPos2.y))
		{
			return false;
		}
		if ((topLeftPos1.x >= topLeftPos2.x) || (topLeftPos2.x >= topLeftPos1.x))
		{
			return false;
		}
		if ((topLeftPos1.y >= topLeftPos2.y) || (topLeftPos2.y >= topLeftPos1.y))
		{
			return false;
		}
		return true;
	...
	{
		Point2f leftCirclePos{ c1.center.x - c1.radius,c1.center.y };
		Point2f rightCirclePos{ c1.center.x + c1.radius,c1.center.y };
		Point2f bottomCirclePos{ c1.center.x, c1.center.y - c1.radius };
		Point2f topCirclePos{ c1.center.x,c1.center.y + c1.radius };
		return (IsPointInCircle(leftCirclePos, c2) || IsPointInCircle(rightCirclePos, c2)
			|| IsPointInCircle(bottomCirclePos, c2) || IsPointInCircle(topCirclePos, c2));
	}
